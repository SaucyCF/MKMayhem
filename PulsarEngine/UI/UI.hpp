...
enum BMG {
    ...
    BMG_KO_TIE = 0x286c,
    BMG_KO_SUPERPOWER = 0x286d,
    BMG_KO_DISCONNECTED = 0x286e,
    BMG_KO_UNDERDOG = 0x286f,
    BMG_KO_SUPERRAREPOWER = 0x2870,
    ...
    BMG_PLAY_UNKNOWNITEMS = 0x6926,
    BMG_PLAY_ITEMRAIN = 0x6927,
    BMG_PLAY_BUMPERKARTS = 0x6928,
    BMG_PLAY_MAYHEMMODE = 0x6929,

    BMG_VS_150CC = 0x5a0,
    BMG_VS_ITEMRAIN = 0x60000,
    BMG_VS_MAYHEMMODE = 0x60001,
    BMG_VS_MKDS = 0x60002,
    BMG_VS_WORLD = 0x60003,

    BMG_FROOM_200CC = 0x10e5,
    BMG_FROOM_50CC = 0x60010,
    BMG_FROOM_100CC = 0x60011,
    BMG_FROOM_400CC = 0x60012,
    BMG_FROOM_99999CC = 0x60013,

    BMG_GP_50CC = 0x60020,
    BMG_GP_100CC = 0x60021,
    BMG_GP_400CC = 0x60022,
    BMG_GP_99999CC = 0x60023,
};
