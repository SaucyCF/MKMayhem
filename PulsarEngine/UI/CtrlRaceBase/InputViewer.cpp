...
u32 CtrlRaceInputViewer::Count() {
    if(static_cast<Pulsar::DKWSettingInputDisplay>(Pulsar::Settings::Mgr::Get().GetUserSettingValue(static_cast<Pulsar::Settings::UserType>(Pulsar::Settings::SETTINGSTYPE_DKW5), Pulsar::SETTINGDKW_INPUTVIEWER)) == Pulsar::DKWSETTING_INPUTDISPLAY_ENABLED) {
